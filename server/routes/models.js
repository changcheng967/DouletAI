...
// External provider models (prefix maps to routing)
const EXTERNAL_MODELS = {
  ...
  // Arli AI (all models have "(TRIAL) " prefix on the API side)
  ...(ARLIAI_API_KEY ? {
  ...
  // FreeTheAi — curated selection of models not available on NVIDIA NIM
  ...(FREETHEAI_API_KEY ? {
...
// Tested and CONFIRMED WORKING on NVIDIA free tier (2025-05-13)
